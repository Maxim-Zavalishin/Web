        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.InsertData(
                table: "Workers",
                columns: new[] { "Id", "DateCreated", "Email", "IdRole", "Lastname", "Name", "Password" },
                values: new object[] { 1, new DateTime(2023, 1, 12, 19, 29, 53, 753, DateTimeKind.Local).AddTicks(4517), "Admin@mail.ru", 3, null, "Admin", "A025909419C60C43FB7163D8D776AE93" });
